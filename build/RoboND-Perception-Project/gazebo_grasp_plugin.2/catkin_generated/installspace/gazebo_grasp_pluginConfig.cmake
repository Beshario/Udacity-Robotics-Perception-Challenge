...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/beshari/catkin_ws/src/RoboND-Perception-Project/gazebo_grasp_plugin.2)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/beshari/catkin_ws/install/${idir}'.  Ask the maintainer 'Jennifer Buehler <jennifer.e.buehler@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/beshari/catkin_ws/install/lib;/home/beshari/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
