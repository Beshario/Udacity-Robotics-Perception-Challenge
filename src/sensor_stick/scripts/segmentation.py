...
def pcl_callback(pcl_msg):
    ...
    # Segmenting with RANSAC and Plane model to identify the table
    ...
    # Convert the xyzrgb cloud to only xyz 
    white_cloud = XYZRGB_to_XYZ(cloud_objects)
    # k-d tree decreases the computation of searching for neighboring points
    #   PCL's euclidian clustering algorithims only takes Kd trees
